...
class PhoneBook
{
  ...
  static void Main()
  {
    ...
    {
      Console.WriteLine("Would you like to look up a contact or number? ['Y' for yes, 'enter' for no]");
  ...
  static void AddContact()
  {
    ...
    string name = Console.ReadLine();
      ...
      {
        Console.WriteLine("Tat person isalready in yor phnebook. Teir number is " + phoneNumbers[name]);
      }
      else
      {
